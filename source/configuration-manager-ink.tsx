...
export const ConfigurationManagerInk: React.FC<
	ConfigurationManagerInkProps
> = ({ onExit, baseDir = process.cwd(), autoSave = false }) => {
	const [activeTab, setActiveTab] = useState(0);
	const [status, setStatus] = useState('Initializing...');
	const [error, setError] = useState<string | null>(null);
	const [configManager, setConfigManager] =
		useState<CoreConfigurationManager | null>(null);
	const [credentialManager, setCredentialManager] =
			...
			>
				{activeTab === 0 && (
					<Box flexDirection="column">
						...
						<Box marginTop={1}>
							...
							<Text>
								• Each agent has tools, endpoints, and access patterns
							</Text>
				...
				{activeTab === 2 && (
					<Box flexDirection="column">
						...
						<Text color="gray">Manage API keys and authentication tokens.</Text>
						<Box marginTop={1}>
							<Text color="yellow">
				...
				{activeTab === 4 && (
					<Box flexDirection="column">
						...
						<Text color="gray">Import and export configuration presets.</Text>
						<Box marginTop={1}>
