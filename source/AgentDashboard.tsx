...
const DashboardHeader: React.FC<{ currentView: DashboardView }> = ({
	currentView
}) => (
	<Box
...
const NavButton: React.FC<{ label: string; active: boolean }> = ({
	label,
	active
}) => (
...
const DashboardContent: React.FC<{ currentView: DashboardView }> = ({
	currentView
}) => {
	switch (currentView) {
		case 'overview':
